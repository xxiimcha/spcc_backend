<?php
// Manual sync script for all tables
...
echo "<h1>🔄 Manual Firebase Sync</h1>";
...
try {
    ...
    echo "<p>Professors: <strong>{$profCount}</strong></p>";
    echo "<p>Sections: <strong>{$secCount}</strong></p>";
    echo "<p>Schedules: <strong>{$schCount}</strong></p>";
    echo "<p>Rooms: <strong>{$roomCount}</strong></p>";
    
    if ($profCount == 0 && $secCount == 0 && $schCount == 0 && $roomCount == 0) {
        echo "<p style='color: orange;'>⚠️ No data to sync. Add some data first!</p>";
        echo "<p><a href='professors.php' style='background: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>Add Professor</a></p>";
        echo "<p><a href='sections.php' style='background: #28a745; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>Add Section</a></p>";
        echo "<p><a href='schedule.php' style='background: #ffc107; color: black; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>Add Schedule</a></p>";
        echo "<p><a href='rooms.php' style='background: #6f42c1; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>Add Room</a></p>";
        exit;
    }
    ...
    echo "<p><a href='manual_sync.php' style='background: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>🔄 Run Sync Again</a></p>";
